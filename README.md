...
- **Languages & Frameworks:** Python (Django, Flask, FastAPI); JavaScript / TypeScript, React, Astro, NextJS; Ruby on Rails; Elixir / Phoenix
- **Databases:** PostgreSQL, SQLite, Prisma, SQLAlchemy, Django ORM, Active Record; Data modeling for production systems
- **CI/CD and Infrastructure:** Docker, Linux, Nginx, Dokku (self-hosted Heroku-style deployments to VPS), AWS S3
- **Product, Systems, & Integrations:** End-to-end ownership of full-stack web applications; API design and third-party integrations; Stripe, Square; Legacy system modernization
